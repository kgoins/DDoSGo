...
func (procStreamCmd ProcDataStreamCmd) ExecCmd() {
	...
	procStreamCmd.alertingSystem.ProcessDataStream(procStreamCmd.agent_ip, procStreamCmd.cpu, procStreamCmd.mem, procStreamCmd.bytesRecvd, procStreamCmd.bytesSent)
}
